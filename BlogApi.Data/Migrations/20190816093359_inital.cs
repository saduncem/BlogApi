        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostGuid = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostAuthors_Author_AuthorId1",
                        column: x => x.AuthorId1,
                        principalTable: "Author",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PostAuthors_Post_PostId1",
                        column: x => x.PostId1,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostAuthors_AuthorId1",
                table: "PostAuthors",
                column: "AuthorId1");

            migrationBuilder.CreateIndex(
                name: "IX_PostAuthors_PostId1",
                table: "PostAuthors",
                column: "PostId1");
